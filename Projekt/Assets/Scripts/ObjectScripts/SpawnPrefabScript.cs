...
namespace ObjectScripts
{
    public class SpawnPrefabScript : MonoBehaviour
    {
        ...
        [Range(0, 1)] public float randomRange;
        ...
        {
            _tts = ((Random.value - 0.5f) * randomRange + 1) *
                   spawnEveryXSeconds; //Bei randomRange = 0.2 == [-0.2, 0.2] von spawnZeit wird zufällig hinzugefügt, also [0.8,1.2] von SpawnZeit
